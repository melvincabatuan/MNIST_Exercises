...
std::string outputFilename = "MLP_MNIST.xml";
...
/************** BEGIN CLASSIFIER TRAIN AND TEST ******************/
    ...
    // 4. Create classifier and Train 
     ...
     Mat train_data = data.rowRange(0, NUM_TRAIN_IMAGES);
     Mat train_responses = Mat::zeros( NUM_TRAIN_IMAGES, class_count, CV_32F );
     ...
     {
            int cls_label = responses.at<int>(i) - '0';
